            ...
            <div className={Styles.dGrid}>
                {data.map((product) => {
                    ...
                    return (<div className={Styles.cardElement}>
                        ...
                        <svg class="salesIcon" viewBox="0 0 100 100"> <circle cx="50" cy="50" r="45" fill="none" stroke="#ccc" stroke-width="5" stroke-dasharray="283" stroke-dashoffset="283"> <animate attributeName="stroke-dashoffset" from="283" to="0" dur="2s" fill="freeze" /> </circle> <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#6a6a6a" font-family="Montserrat-500" font-size="36px" line-height="42px" text-shadow="2px 2px 2px rgba(0, 0, 0, 0.5)" text-transform="uppercase"> <tspan>{product.Sales}</tspan> </text> </svg>
                        </div>
