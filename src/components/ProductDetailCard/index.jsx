        ...
        <div className="container mt-4 product-card-element">
            <div className="d-flex">
                ...
                <div className="col-8 ml-4 product-card-element-holder" >
                    ...
                    {product?.data?.Description && <p style={{ textAlign: 'start', color: "#898989" }}>
                            {isDescriptionExpanded ? (
                                product.data.Description
                            ) : (
                                product.data.Description.substring(0, 750)+"..."
                            )}
                            {<button style={{ textDecoration: 'underline' }} onClick={() => setIsDescriptionExpanded(!isDescriptionExpanded)}>{isDescriptionExpanded ? 'Learn Less' : 'Learn More'}</button>}
                    </p>}
                        ...
                        <>
                            {orders[product?.data?.Id] ?
                                <div className="d-flex flex-column">
                                    ...
                                    <p className="mt-3" style={{ textAlign: 'start' }}>Total: <b>{inputPrice * orders[product?.data?.Id]?.quantity}</b></p>
                                </div> :
                    ...
                    </> : <div className="d-flex gap-4"><Link to={toRedirect} className={Styles.button}>Add to cart</Link></div>}
                </div>
            </div>
            <hr></hr>
