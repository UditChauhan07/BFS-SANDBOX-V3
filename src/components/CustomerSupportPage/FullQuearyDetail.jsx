                ...
                <div className={`row ${Detail.FlexReverse}`}>
                    <div className='col-lg-9 col-md-9 col-sm-12'>
                        <div className={Detail.LeftMainDiv}>
                            ...
                            <p className={Detail.Description} >{data.Description?.split("User Desc:").length == 2 ? <>{data.Description.split("User Desc:")[1].split("Issue Desc:")[1]}<br /><b>User Description:</b> {data.Description.split("User Desc:")[1].split("Issue Desc:")[0]}</> : data.Description}</p>
